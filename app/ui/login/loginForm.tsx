                                        ...
                                        <div className="flex flex-col gap-2 items-center">
                                            <div className="gap-2 p-2">
                                                ...
                                                <div className="flex flex-col gap-2 p-2">
                                                    {/* Google Btn */}
                                                    <button className="bg-white flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100 w-70">
                                        ...
                                        <form action="#" method="POST" className="flex flex-col space-y-6"> 
                                            ...
                                            <div className="flex min-h-full flex-col justify-center ">
                                                ...
                                                <div className="flex items-center p-2">
                                                    ...
                                                    <span className="mx-4 text-sm text-black/60">Or type your credentials</span>
                                                    <div className="h-px flex-1 bg-black/20" />
                                                </div>
